...
const CoursesDetails = () => {
    ...
    const { courseTitle, advisor, description, image, category, lectures, videos } = location.state.item
    ...
    console.log(video.map((item, index) => item.duration))
    const Categories = [
        {
                    ...
                    <div className='bg-white h-max flex flex-col   p-3 lg:p-10'>
                        ...
                        <div className="tab-content" id="tabs-tabContent">
                            ...
                            <div className="tab-pane fade" id="tabs-profile" role="tabpanel" aria-labelledby="tabs-profile-tab">
                                <p className='text-[#8a8a8a] text-sm'>But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system and expoune.</p>
