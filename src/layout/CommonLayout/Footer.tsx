  ...
  return (
    <div className="relative">
      <div className="pt-20 grid grid-cols-2 footer-img justify-center gap-4 md:flex md:justify-between pb-44 px-5">
        <ImageWithFallback src={"/assets/Logo/brand1.png"} alt="Brand 1" />
        <ImageWithFallback src={"/assets/Logo/brand2.png"} alt="Brand 2" />
        <ImageWithFallback src={"/assets/Logo/brand3.png"} alt="Brand 3" />
        <ImageWithFallback src={"/assets/Logo/brand4.png"} alt="Brand 4" />
        <ImageWithFallback src={"/assets/Logo/brand5.png"} alt="Brand 5" />
      </div>
      <div className="bg-[#fdc800] w-[96%] grid md:flex justify-between absolute top-[350px] md:top-[250px] md:w-[90%] mx-2 md:mx-5 px-3 py-10">
        ...
        <form className="flex items-center">
          <input
            className="outline-none border-none bg-white h-10 w-72 rounded text-sm ps-3"
      ...
      <div className=" bg-[#002147]">
        <div className="grid md:flex gap-14 px-4 md:px-10 pb-5 pt-32 text-[#cbcbcb]">
          <div className="w-full">
            <ImageWithFallback src={"/assets/Logo/logo_2.png"} alt="Footer" />
            <p className="text-sm py-3 leading-7 text-justify">
              Sorem ipsum dolor sit amet conse ctetur adipiscing elit, sed do
              eiusmod incididunt ut labore et dolore magna aliqua. Utenim ad
              minim veniam, quis nostrud exercition ullamco laboris nisi
            </p>
            <h3 className="text-base font-semibold">Follow us</h3>
            <div className="flex justify-between w-40">
              <i className="text-[#cbcbcb]">
                <GrFacebookOption />
              </i>
              <i className="text-[#cbcbcb]">
                <TiSocialTwitter />
          ...
          <div className="w-full">
            <h2 className="text-[#fdc800] text-xl font-semibold text-start">
              Qucik Links
            </h2>
        ...
        <div className="flex justify-center border-t-[1px] mx-5 border-[#0e88d3]">
          <p className="m-0 py-4 text-[#1696e7] ">
            Designed and Developed By Saqib
          </p>
        </div>
      </div>
    </div>
